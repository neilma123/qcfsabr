...
int main()
{
    // S&P 500
    // nelson_mead();
    Quote *snp500 = new Quote("AAPL240322C00100000");
    std::time_t period1 = dateToEpoch("2024-03-14");
    cout << period1 << endl;
    // Get the historical spots from Yahoo Finance
    snp500->getHistoricalSpots("2024-03-14", "2024-03-15", "1d");
    ...
    // Print a spot
    try {
        Spot spot = snp500->getSpot("2024-03-14");
        std::cout << "Spot at 2024-03-15: " << std::endl;
        spot.printSpot();
    ...
    // Get the historical spots from Yahoo Finance
    //snp500->getHistoricalSpots("2024-03-15", "2017-12-31", "1d");
    ...
    // Print a spot
    // try {
    //     Spot spot = snp500->getSpot("2024-03-15");
    //     std::cout << "Spot at 2024-03-15: " << std::endl;
    //     spot.printSpot();
    // } catch(const std::exception &e) {
    //     std::cerr << e.what() << std::endl;
