...
SABRVanna <- function(F0, K, tex, rfr, Alpha, Beta, Rho, Nu){
  ...
  SABRBumpRhoUp <- SABRFunctions::SABRParamLinearBump(F0, K, tex, Alpha, Beta, Rho, Nu, 'Rho', bumpdir = 'up')
  SABRBumpRhoDn <- SABRFunctions::SABRParamLinearBump(F0, K, tex, Alpha, Beta, Rho, Nu, 'Rho', bumpdir = 'dn')
