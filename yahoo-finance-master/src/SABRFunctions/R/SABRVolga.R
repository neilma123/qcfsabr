...
SABRVolga <- function(F0, K, tex, rfr, Alpha, Beta, Rho, Nu){
  ...
  SABRBumpNuUp <- SABRFunctions::SABRParamLinearBump(F0, K, tex, Alpha, Beta, Rho, Nu, 'Nu', bumpdir = 'up')
  SABRBumpNuDn <- SABRFunctions::SABRParamLinearBump(F0, K, tex, Alpha, Beta, Rho, Nu, 'Nu', bumpdir = 'dn')
