...
#'
#' @return Single numeric value correspoding to the ATM Black-76-equivalent volatility for the given Alpha
#'
#' @export
#'
#' @examples
...
#'  Nu = 1.0504)
SABRAlphaCubic <- function(x, F0, ATMVol, tex, Beta, Rho, Nu){
